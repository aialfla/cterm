...
<body>
	...
	<main id="main">
		...
		<section id="main_warp">
			...
			<input type='hidden' value="${ mv.id }" name='checkIds'>
						...
						<li>
							...
							<div class="content">
								<ul class="list_auth" id="lists">
									<li><span class='duty'>${ mv.dutyName }</span><span class='name'>${ mv.name }</span></li>
								</ul>
...
<!-- 								</button> -->
						...
						<li>
							...
							<div class="content">
								<textarea name="note" placeholder="내용을 입력해주세요" id="note"></textarea>
							</div>
						</li>
					</ul>
					<!-- = 사원목록 popup 시작 = -->
							...
							<div class="info_warp">
								...
								<div class="info_container">
									...
									<div class="check_wrap">
										...
										<ul id="dept_click_1" class="hidden">
											<c:forEach var="item" items="${ olists }" varStatus="status">
												<c:if test="${ item.dept eq 1 }">
													<li>
										...
										<ul id="dept_click_2" class="hidden">
											<c:forEach var="item" items="${ olists }" varStatus="status">
												<c:if test="${ item.dept eq 2 }">
													<li>
														<div class="checkbox_wrap">
										...
										<ul id="dept_click_3" class="hidden">
											<c:forEach var="item" items="${ olists }" varStatus="status">
												<c:if test="${ item.dept eq 3 }">
													<li>
														<div class="checkbox_wrap">
