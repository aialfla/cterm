					...
					<div class="info_warp">
						<div class="tit_container">
							<div class="sender">
								...
								<p>
									<span class="rank">
										<c:if test="${ msg.duty_r == 0 }">
											관리자
										</c:if>
										<c:if test="${ msg.duty_r == 1 }">
											대표
										</c:if>
										<c:if test="${ msg.duty_r == 2 }">
											부장
										</c:if>
										<c:if test="${ msg.duty_r == 3 }">
											팀장
										</c:if>
										<c:if test="${ msg.duty_r == 4 }">
											사원
										</c:if>
									</span>
									<span class="name">${ msg.name_r }
									</span>
								</p>
							</div>
					...
					<div class="btn_wrap MT10">
						<ul>
							<li>
								...
								<a href="javascript:checkDelete(${msg.msgtoNO})" class="btn_primary" title="발신취소">발신취소</a>
								</c:if>
							</li>
							<li>
