...
<body>
	...
	<main id="main">
		...
		<section id="main_warp">
			<!-- == 서브타이틀 시작 ===================================================================== -->
			<h3 class="title">기안 작성</h3>
			<!-- == 서브타이틀 종료 ===================================================================== -->
			
			<!-- == 작성 폼 시작 ===================================================================== -->
			<form name="frm" method="post" action="write.do" enctype="multipart/form-data">
				<div class="write_wrap">
					...
					<ul class="write_container">
						<li>
							...
							<div class="content">
								<input class="col_w100" type="text" id="title" name="title" placeholder="제목을 입력해주세요">
							</div>
						</li>
						<li>
						...
						<li>
							...
							<div class="content">
								<textarea id="note" name="note" placeholder="내용을 입력해주세요"></textarea>
							</div>
						</li>
						<li>
...
<!-- 				<div id="popup" class="active"> -->
				...
				<div class="btn_wrap MT60">
					<ul>
						<li>
							<a href="<%= request.getContextPath() %>/docu/list_mine.do" class="btn_light">목록으로</a>
						</li>
						<li>
							<button type="button" class="btn_primary" onclick="checkBlank()">결재요청</button>
						</li>
					</ul>
				</div>
				<!-- == /버튼 종료 ===================================================================== -->
